...
namespace MyLambdaProject.Tests
{
    public class FunctionTest
    {
        ...
        public async Task TestSQSLambdaFunction()
        {
            ...
            mockOpenAiService.Setup(openAi => openAi.GetCompletionAsync(It.IsAny<string>()))
                             .Returns(Task.FromResult("Hello from OpenAI!"));

            // Mock the ISnsService
            var mockSnsService = new Mock<ISnsService>();
            mockSnsService.Setup(sns => sns.PublishMessageAsync(It.IsAny<string>()))
            ...
            serviceCollection.AddSingleton(mockOpenAiService.Object);
            serviceCollection.AddSingleton(mockSnsService.Object);
            ...
            // Assert
            mockSnsService.Verify(sns => sns.PublishMessageAsync(It.IsAny<string>()), Times.Once);
            mockOpenAiService.Verify(ai => ai.GetCompletionAsync(It.IsAny<string>()), Times.Once);
